...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col selection:bg-indigo-500 selection:text-white">
      ...
      {/* PRICING */}
      <section id="pricing" className="py-20 bg-gray-50 border-t border-gray-200 px-6 sm:px-12">
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold text-gray-950">Simple, Transparent Pricing</h2>
            <p className="text-sm text-gray-500">Put more buy buttons on the internet. Zero hidden fees.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            {/* Free */}
            <div className="bg-white p-7 rounded-2xl border border-gray-200 flex flex-col justify-between shadow-xs">
              <div className="space-y-4">
                <div className="text-xs font-bold text-gray-400 uppercase tracking-wider">Free Starter</div>
                <div className="text-3xl font-black text-gray-950">$0</div>
                <p className="text-xs text-gray-500">Perfect for building and testing your first resume.</p>
                <ul className="space-y-2.5 text-xs text-gray-700 pt-3 border-t border-gray-100">
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> 1 Active Resume</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> 3 AI Bullet Rewrites</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Standard RenderCV PDF Export</li>
                </ul>
              </div>
              <Link href="/login" className="mt-8 block text-center bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-2.5 rounded-xl text-xs transition-colors">
                Start Free
              </Link>
            </div>

            {/* 30-Day Pass */}
            <div className="bg-white p-7 rounded-2xl border-2 border-indigo-600 flex flex-col justify-between shadow-lg relative">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] uppercase font-bold tracking-wider px-3 py-0.5 rounded-full">
                Most Popular
              </span>
              <div className="space-y-4">
                <div className="text-xs font-bold text-indigo-600 uppercase tracking-wider">30-Day Pass</div>
                <div className="text-3xl font-black text-gray-950">$9 <span className="text-xs text-gray-400 font-normal">one-time</span></div>
                <p className="text-xs text-gray-500">Active job seeker sprint pass with zero recurring billing.</p>
                <ul className="space-y-2.5 text-xs text-gray-700 pt-3 border-t border-gray-100">
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Resumes</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited AI XYZ Rewrites</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Unlimited Job Tailoring & ATS Scores</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> All 9 Industry Templates</li>
                </ul>
              </div>
              <Link href="/login" className="mt-8 block text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 rounded-xl text-xs transition-colors shadow-sm">
                Get 30-Day Pass ($9)
              </Link>
            </div>
            ...
            <div className="bg-white p-7 rounded-2xl border border-gray-200 flex flex-col justify-between shadow-xs">
              <div className="space-y-4">
                <div className="text-xs font-bold text-gray-400 uppercase tracking-wider">Pro Monthly</div>
                <div className="text-3xl font-black text-gray-950">$19 <span className="text-xs text-gray-400 font-normal">/mo</span></div>
                <p className="text-xs text-gray-500">For ongoing career management, continuous tailoring, and updates.</p>
                <ul className="space-y-2.5 text-xs text-gray-700 pt-3 border-t border-gray-100">
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Everything in 30-Day Pass</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Priority RenderCV queue</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /> Cancel anytime</li>
                </ul>
              </div>
              <Link href="/login" className="mt-8 block text-center bg-gray-900 hover:bg-black text-white font-semibold py-2.5 rounded-xl text-xs transition-colors">
                Subscribe ($19/mo)
              </Link>
            </div>
          </div>
